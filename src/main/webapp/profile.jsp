...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link" href="#"> <span
						class="fa fa-street-view"> </span> HARISH<span class="sr-only">(current)</span></a>
				</li>
				...
				<li class="nav-item"><a class="nav-link" href="#"
					data-toggle="modal" data-target="#add-post-modal"> <span
						class="fa fa-asterisk mr-1"></span>POST YOUR OWN BLOG
				</a></li>
		...
		<div class="container mb-10">
			...
			<div class="row mt-5">
				...
				<div class="col-md-10" >
					...
					<div class="list-group">
						...
						<a href="#" onclick="getPosts(<%=cc.getCid()%>,this)"
							class="  c-link      list-group-item list-group-item-action"><%=cc.getName().toUpperCase()%></a>
				...
				<div class="col-md-10 mt-10">
					...
					<div class=" mt-10 container text-center" id="loader">
	...
	<footer class="text-center text-white" style="background-color: #-webkit-linear-gradient(left, #0072ff, #00c6ff); margin-top:500px;">
